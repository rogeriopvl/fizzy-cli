...
func TestReactionDeleteCommandSuccess(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path != "/test-account/cards/123/comments/comment-456/reactions/reaction-789" {
			t.Errorf("expected /test-account/cards/123/comments/comment-456/reactions/reaction-789, got %s", r.URL.Path)
		}
